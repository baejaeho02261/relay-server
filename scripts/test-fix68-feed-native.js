...
assert.match(render,/Inset:=16;if Parent=FHubComposeTail then Inset:=12/,'poll choices retain an inner gutter inside the post-sized composer');
assert.match(render,/Parent.Width-Inset\*2,48/);assert.match(render,/Result.Fill.Kind:=TBrushKind.None/);assert.match(render,/Result.Stroke.Kind:=TBrushKind.Solid/);
