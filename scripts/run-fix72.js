...
const checks=[
 ...
 ['test-fix72-payment-setup.js'],['test-fix72-payment-setup.js','--sqlite']
];
let failures=0;
...
console.log(`${checks.length-failures}/${checks.length} FIX72 checks passed. Delphi/Android execution is not included.`);
