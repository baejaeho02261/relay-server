...
const messages={PAYMENT_UNAVAILABLE:'현재 이 결제수단으로 충전할 수 없습니다. 결제 설정 안내를 확인하거나 고객센터에 문의해주세요.',PAYMENT_PROVIDER_CONFIG:'결제 서비스의 가맹점 연결을 확인해야 합니다. 고객센터에 문의해주세요.',ADMIN_CONFIRM_REQUIRED:'대상 회원과 금액을 확인한 후 다시 진행해주세요.',ADMIN_REASON_REQUIRED:'처리 사유를 3자 이상 입력해주세요.',PAYMENT_FAILED:'결제를 완료하지 못했습니다. 다시 시도해주세요.',PAYMENT_EXPIRED:'결제 요청이 만료되었습니다. 다시 시도해주세요.',PAYMENT_CANCELLED:'결제가 취소되었습니다.',IDENTITY_DEVICE_REQUIRED:'기기 인증과 권한 설정을 먼저 완료해주세요.',IDENTITY_NOT_CONFIGURED:'관리자가 카카오·Google 로그인 설정을 완료해야 합니다.',IDENTITY_PROVIDER_INVALID:'지원하는 계정을 선택해주세요.',IDENTITY_FLOW_EXPIRED:'계정 연결 요청이 만료되었습니다. 다시 연결해주세요.',IDENTITY_LINKED_ELSEWHERE:'이미 다른 기기에 연결된 계정입니다. 계정 소유 확인이 필요합니다.',IDENTITY_ACCOUNT_CHANGED:'현재 연결된 계정으로 로그인해주세요.',IDENTITY_CANCELLED:'계정 연결이 취소되었습니다.',IDENTITY_TOKEN_INVALID:'계정 인증 응답을 확인하지 못했습니다.',IDENTITY_PROVIDER_UNAVAILABLE:'계정 인증 서비스에 연결하지 못했습니다. 다시 시도해주세요.',IDENTITY_REQUIRED:'카카오 또는 Google 계정을 먼저 연결해주세요.',COMMENTS_DISABLED:'이 게시글은 댓글 작성이 해제되어 있습니다.',POST_ARCHIVED:'보관한 게시글은 먼저 보관을 해제해주세요.',POST_PIN_LIMIT:'프로필에는 게시글을 최대 3개까지 고정할 수 있습니다.',POST_SHARE_UNAVAILABLE:'이 회원에게는 게시글을 공유할 수 없습니다.',PROFILE_CHANGED:'프로필이 변경되었습니다. 최신 내용을 확인한 후 다시 저장해주세요.',PROFILE_LINK_INVALID:'링크 제목과 올바른 http 또는 https 주소를 확인해주세요.',PROFILE_BANNER_INVALID:'배너 제목과 음악 주소 또는 회원 아이디를 확인해주세요.',PROFILE_GRID_INVALID:'본인이 작성한 게시글만 순서를 바꿀 수 있습니다.',PROFILE_TAG_INVALID:'사진 또는 GIF에 태그할 회원을 다시 확인해주세요.',ACCOUNT_LIST_LIMIT:'목록에는 최대 1,000명을 추가할 수 있어요.',INTERACTION_UNAVAILABLE:'회원의 소통 설정으로 요청할 수 없습니다.',REPOST_UNAVAILABLE:'회원이 게시글 공유를 허용하지 않았습니다.',DM_REQUEST_REQUIRED:'받은 대화 요청을 먼저 확인해주세요.',DM_NOT_FOUND:'대화를 찾을 수 없습니다.',DM_UNAVAILABLE:'대화할 수 없는 회원입니다.',DM_SELF:'본인과는 대화할 수 없습니다.',DM_DELETED:'삭제된 대화입니다. 회원 프로필에서 새 대화를 시작해주세요.',DM_TEXT_INVALID:'메시지를 1~2,000자로 입력해주세요.',DM_DELETE_CONFIRM:'양쪽 대화를 삭제할지 확인해주세요.',DM_FULL:'새 대화를 시작해주세요.',TITLE_COLOR_INVALID:'칭호 글자색과 아이콘색을 확인해주세요.',TITLE_NAME_INVALID:'칭호 이름을 1~20자로 입력해주세요.',ALL_TITLES_REQUIRED:'모든 칭호를 먼저 획득해주세요.',TITLE_COLOR_TICKET_REQUIRED:'칭호 색상 이용권이 필요합니다.',TITLE_NAME_TICKET_REQUIRED:'칭호 이름 변경권이 필요합니다.',SHOP_UNAVAILABLE:'상점 상품을 준비 중입니다.',INVENTORY_LIMIT:'보유 가능한 수량을 확인해주세요.',COLOR_TICKET_REQUIRED:'닉네임 색상 이용권이 필요합니다.',NICKNAME_COLOR_INVALID:'올바른 색상을 선택해주세요.',BADGE_UNAVAILABLE:'아직 획득하지 않은 배지입니다.',POINT_CONVERSION_NOT_FOUND:'교환 내역을 찾을 수 없습니다.',POINT_CONVERSION_INVALID:'교환 내역과 거래 기록을 확인해주세요.',POINT_RECOVERY_BALANCE:'사용 가능한 충전 잔액이 부족해 교환을 회수할 수 없습니다.',EVENT_CLOSED:'지금은 이벤트를 준비 중입니다.',EVENT_NO_TURNS:'충전 후 지급되는 참여 횟수를 확인해주세요.',POINT_BALANCE_INVALID:'포인트 잔액을 확인해주세요.',POLL_TEXT_LONG:'선택지를 조금 더 짧게 입력해주세요.',POLL_ALREADY_VOTED:'이미 참여한 투표는 다시 선택하거나 변경할 수 없습니다.',REPOST_COMPOSE_REQUIRED:'피드 작성에서 원글과 함께 이야기를 남겨주세요.',COMMENT_NOT_FOUND:'삭제되었거나 볼 수 없는 댓글입니다.',POLL_INVALID:'투표 질문과 선택지 2~4개를 입력해주세요.',POLL_LOCKED:'참여자가 있는 투표는 선택지를 변경할 수 없습니다.',GIF_INVALID:'2MB 이하, 가로·세로 1024 이하의 GIF를 선택해주세요. 최대 180프레임까지 지원합니다.',ADMIN_ONLY:'관리자 전용 정보입니다.',MEMBER_DEVICE_SELECT:'연결된 기기를 선택해주세요.',HANDLE_INVALID:'아이디는 영문 소문자·숫자·밑줄·점으로 3~24자 입력해주세요.',HANDLE_TAKEN:'이미 사용 중인 아이디입니다.',HANDLE_LOCKED:'아이디는 최초 한 번만 변경할 수 있습니다.',NICKNAME_COOLDOWN:'닉네임은 마지막 변경일로부터 30일 후 바꿀 수 있습니다.',CONTENT_IMAGE_INVALID:'사진 형식이나 크기를 확인해주세요. 다른 사진을 선택해주세요.',CONTENT_URL_INVALID:'채널 주소는 올바른 http 또는 https 주소로 입력해주세요.',...require('./messages'),INPUT_INVALID:'입력 내용을 확인해주세요.',AMOUNT_INVALID:'금액을 확인해주세요.',ACCOUNT_REQUIRED:'회원 정보를 확인할 수 없습니다.',MEMBER_NOT_FOUND:'회원을 찾을 수 없습니다.',ACCOUNT_BLOCKED:'이용이 제한된 계정입니다. 고객센터에 문의해주세요.',MEMBER_AUTH_REQUIRED:'기기 승인과 생체인증을 먼저 완료해주세요.',SERVICE_DISABLED:'서비스가 종료되었습니다.',STORAGE_SAVE_FAILED:'저장하지 못했습니다. 같은 요청으로 다시 시도해주세요.',PRODUCT_NOT_FOUND:'게임을 찾을 수 없습니다.',PRODUCT_UNAVAILABLE:'공개된 게임을 찾을 수 없습니다.',PRICE_CHANGED:'가격 또는 게임 정보가 변경되었습니다. 다시 확인해주세요.',SOLD_OUT:'품절된 상품입니다.',INSUFFICIENT_BALANCE:'잔액이 부족합니다. 충전 후 다시 구매해주세요.',BALANCE_INVALID:'잔액 한도를 확인해주세요.',TOPUP_UNAVAILABLE:'충전 방식은 준비 중입니다.',ORDER_NOT_FOUND:'구매 내역을 찾을 수 없습니다.',ORDER_REFUNDED:'환불된 구매 내역입니다.',PASS_EXPIRED:'이용권 기간이 만료되었습니다.',ACTIVATED_REFUND_REVIEW:'이미 사용한 이용권은 개별 환불 검토가 필요합니다.',AVATAR_INVALID:'프로필 사진을 다시 선택해주세요.',POST_NOT_FOUND:'삭제되었거나 숨겨진 글입니다.',NOT_OWNER:'본인이 작성한 내용만 변경할 수 있습니다.',PLEASE_WAIT:'잠시 후 다시 작성해주세요.',REQUEST_REUSED:'요청 번호가 중복되었습니다. 다시 시도해주세요.',REQUEST_ID_INVALID:'요청 정보를 확인해주세요.',UNKNOWN_ACTION:'지원하지 않는 작업입니다.'};
function BaseAllowed(c){return require('./identity').Ready(c)&&!!c&&state.serviceEnabled&&require('../haCoordinator').CanAcceptTraffic()&&require('../clientPermissions').Ready(c)&&require('../clientInstallation').Ready(c)&&c.licenseAuthorized===true&&require('../deviceAuth').Verified('CLIENT',c.clientId);}
...
function CurrentWallet(p,data,body={},includeWallet=false){
 ...
 if(data.wallet?.accountId===p.id||includeWallet&&!own&&!data.wallet)result.wallet=require('./wallet').Read(p);
...
function Execute(c,requestId,action,body={}){
 if(['identity.status','identity.start','identity.poll'].includes(action))return require('./oauthIdentity').Execute(c,requestId,action,body);
 ...
 if(!Allowed(c)){
  let reason='MEMBER_AUTH_REQUIRED';const identity=require('./oauthIdentity');
  if(identity.PreAllowed(c)&&!s.DB().profiles[s.Subject(c)]?.blocked&&!identity.Ready(c))reason=identity.AccessReason(c)==='IDENTITY_PROVIDER_UNAVAILABLE'?'IDENTITY_PROVIDER_UNAVAILABLE':'IDENTITY_REQUIRED';
  s.Fail(state.serviceEnabled?reason:'SERVICE_DISABLED');
 }
 const p=s.Account(c);if(p.blocked){require('./testAccess').Revoke(c);s.Fail('ACCOUNT_BLOCKED');}
 // A pending retired-round credit retries only for its authenticated owner.
 if(p.retirementRefundPending)require('./retirement').Ensure(p);
 require('./withdraw-retirement').Ensure(p);
 if(action==='game.download')return require('./game-downloads').Issue(p,c,body);
 ...
 const read={home:()=>require('./home').Read(p),archives:()=>require('./post-controls').Archives(p,body),'post.insights':()=>require('./post-controls').Insights(p,body),'post.recipients':()=>require('./post-controls').Recipients(p,body),'profile.details':()=>require('./profile-details').Read(p,body),people:()=>require('./people').Read(p,body),'activity.settings':()=>require('./activity-settings').Read(p),'account.list':()=>require('./activity-settings').List(p,body),topgames:()=>require('./topGames').Read(p,body),notifications:()=>require('./notifications').Read(p,body),history:()=>require('./history').Read(p),shop:()=>require('./customization').Read(p),badges:()=>require('./badges').Read(p,body),popular:()=>social.Popular(p,body),rewards:()=>require('./rewards').Read(p,body),activity:()=>require('./activity').Purchases(p,body),mycomments:()=>require('./activity').Comments(p,body),policies:()=>require('./documents').Read(body),preferences:()=>({preferences:require('./preferences').Read(p),profile:s.PublicProfile(p,true)}),live:()=>require('./live').Read(p,body),gif:()=>{const post=require('./socialActions').Post(p,body.id);return {photo:{id:post.id,gif:require('./gifMedia').Public(post,true)}};},photo:()=>{const post=require('./socialActions').Post(p,body.id);return {photo:{id:post.id,image:post.image||''}};},gifs:()=>require('./gifs').List(),bookmarks:()=>require('./socialActions').Bookmarks(p,body),blocks:()=>require('./socialActions').Blocks(p,body),member:()=>require('./profiles').Read(p,body),follows:()=>require('./follows').List(p,body),charge:()=>require('./payments').Read(p),product:()=>commerce.Product(body,p),article:()=>social.Article(p,body),menu:()=>require('./menu').Read(p),news:()=>social.News(p,body),catalog:()=>({...commerce.Catalog(body,p),profile:s.PublicProfile(p,true)}),me:()=>commerce.Mine(p,body),feed:()=>social.Feed(p,body),thread:()=>social.Thread(p,body)};
 if(read[action])return require('./readScope').Run(()=>{
  ...
  if(!body._ifNoneMatch&&['thread','bookmarks'].includes(action)&&body._since===s.DB().revision)return {unchanged:true,revision:s.DB().revision,memberProtocol:35};
 ...
 const mutations={
  ...
  'payment.start':()=>require('./payments').Start(p,body),'order.activate':()=>commerce.Activate(p,c,body),
...
function AdminWrite(action,body,actor){
 const finish=result=>{if(action==='profile.block'&&result.blocked)require('./testAccess').RevokeMember(result.id);if(action!=='charge.scan')NotifyChanged();return result;};
 const result=require('./admin').Write(action,body,actor);
 return result&&typeof result.then==='function'?result.then(finish):finish(result);
}
module.exports={Execute,Handle,AdminRead,AdminWrite,Allowed,messages,NotifyChanged};
